 ...
 */
    ...
    if(isset($_POST['busqueda'],$_POST['url']))
    {
        ...
        if(!empty($resultado)){
            echo '<p class="text-muted"> localizado '.count($resultado).' arquivo(s) ou pasta(s) no total</p>';
            ...
            echo '<p class="text-center text-muted">Sem resultados</p>';
        }
        die();
    }
        ...
        <div class="container-fluid  main-container">
            <div class="container">
                    ...
                    <div class="col-md-12">
                        <div class="search-box panel panel-default">
                            <div class="panel-body">
                                <input type="text" class="form-control input-lg input-busqueda" placeholder="Buscar arquivos ou pastas..." />
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row folder-view">
                    <div class="col-md-12">
                        <h4>Pastas: <span class="pull-right text-muted"><?= $url;?></span></h4>
                        <hr />
                    </div>
        ...
        <div class="container-fluid footer">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <p class="text-muted">
                        	htdocsMe! 0.3.1 - Criado por <a href="http://github.com/andersonsalas">Anderson Salas</a>
                        	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Traduzido (pt-BR) por <a href="http://github.com/andersonsalas">Manoel Pereira dos Santos</a>
                        </p>
                    </div>
                </div>
            </div>
